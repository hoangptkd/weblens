...
describe('SiteCloneProgress', () => {
  ...
  it('uses candidate totals, exposes current pages, paginates and resets cursor on filtering', async () => {
    ...
    expect(screen.queryByText('Tra log và thông tin chẩn đoán')).not.toBeInTheDocument()
    await user.click(screen.getByRole('button', { name: 'Sao chép chẩn đoán trang 1' }))
